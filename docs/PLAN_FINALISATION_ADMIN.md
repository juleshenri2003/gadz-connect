...
**Structure cible** : SASU **Gadz'Connect** — APE **85.59W** (formation continue d’adultes)  
...
| Recherche marque INPI | https://data.inpi.fr |
| Stripe Connect | https://dashboard.stripe.com |
| Autoentrepreneur URSSAF | https://www.autoentrepreneur.urssaf.fr |
